...
const TreasureHunt = () => {
    ...
    return (
        <div className="container text-center">
            ...
            <div className="my-4 p-2 ms-3">
                <Link className='button my-3 me-3' href='/code'>Enter the code</Link><br />
            </div>
            {session && session.user && session.user.admin && <div className="my-4 p-2 text-center">
                <Link className='button my-3' href='/admin/hunt'>Edit Hints</Link>
            </div>}
